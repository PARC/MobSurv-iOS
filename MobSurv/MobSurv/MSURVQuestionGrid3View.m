...
@interface MSURVQuestionGrid3View ()
...
@implementation MSURVQuestionGrid3View


MSURVSurveyViewController *caller;

-(MSURVQuestionGrid3View *) init{
    MSURVQuestionGrid3View *result = nil;
